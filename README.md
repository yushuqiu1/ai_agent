...
[![smithery badge](https://smithery.ai/badge/@yushuqiu1/attempt_1)](https://smithery.ai/server/@yushuqiu1/attempt_1)
...
To install attempt_1 automatically via [Smithery](https://smithery.ai/server/@yushuqiu1/attempt_1):

```bash
npx -y @smithery/cli install @yushuqiu1/attempt_1
```
